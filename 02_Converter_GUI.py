...
class Converter:
    def __init__(self, parent):
        ...
        #Centigrade button
        self.conv_c_button = Button(self.conv_button_frame, text="Centigrade")
        self.conv_c_button.grid(row=0, column=0, padx=5)

        #F Button
        self.conv_f_button = Button(self.conv_button_frame, text="Fahrenheit")
        self.conv_f_button.grid(row=0, column=1, padx=5)

        #Conv label
        self.conversion_outcome = Label(self.converter_frame, text="Conversion", font="Arial 16 bold", wrap=250, justify=LEFT, bg=bkg_colour, padx=30, pady=30)
